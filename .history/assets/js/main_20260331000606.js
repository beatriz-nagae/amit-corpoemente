...
const profData = {
  marina: {
    ...
    bio:   'Marina é especialista em massoterapia com foco no equilíbrio entre corpo e mente. Sua abordagem combina técnicas clássicas e contemporâneas, oferecendo um atendimento personalizado e acolhedor para cada cliente. Acredita que o autocuidado é um direito de todas as mulheres, independente da rotina.',
    creds: [
